 ...
 * SIGCOMM '88, p. 328.
 */
void tcp_const_cong_avoid(struct sock *sk, u32 ack, u32 acked)
{
...
struct tcp_congestion_ops tcp_reno_verbose = {
	...
	.cong_avoid	= tcp_const_cong_avoid,
...
module_init(tcp_const_register);
module_exit(tcp_const_unregister);

MODULE_AUTHOR("Yanev");
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Const Reno");
